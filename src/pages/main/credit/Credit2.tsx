	...
	return (
		<main role="main" className="home_container">
			<section className="mb-5">
				<div className="flex items-center bg-[#F8EAE1] px-[18px] py-4 rounded-md mb-3 space-x-3">
					...
					<span className="text-[#F24E1E] text-sm font-medium">
						กรุณาระบุยอดฝากเป็นจำนวนเต็มเท่านั้น ระบบ จะทำการสุ่มทศนิยมให้เอง
					</span>
				</div>
											...
											<div className="flex w-full items-center">
												...
												<div className="flex items-center">
													<div className="text-sm">
														<RadioGroup.Label
															as="p"
															className="font-medium text-[#1E1E1E] text-sm">
															{plan.name}
														</RadioGroup.Label>
													</div>
												</div>
			...
			<section className="mb-6">
				...
				<div className="text-xs font-medium text-[#D11500]">กรุณาระบุค่ามากกว่าหรือเท่ากับ 50</div>
			</section>

			<section className="mb-5">
				<Link to="/credit3">
					<button className="button_1 w-full rounded font-semibold py-3.5">ตกลง</button>
				</Link>
			</section>
		</main>
	);
