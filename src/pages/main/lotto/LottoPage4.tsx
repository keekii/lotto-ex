...
const Section1 = () => {
	...
	return (
		<section className="mb-5">
			<div>
				<div className="text-base font-semibold mb-4">เลือกประเภทการซื้อ</div>
			...
			<Card className="px-5 py-4">
				...
				<div className="flex items-center justify-center gap-2 mb-4">
					<div className="bg-[#EF769D] px-2 py-1.5 rounded">
						<div className="text-[8px] text-white">3ตัวบน, 2ตัวล่าง</div>
					</div>
					<div className="text-[#EB5757] text-xs font-medium">+</div>
					<div className="bg-[#68C749] px-2 py-1.5 rounded">
						<div className="text-[8px] text-white">กลับเลขสองตัว</div>
					</div>
				</div>
				...
				<div className="grid grid-rows-4 grid-flow-col gap-3.5">
					...
					<div className="relative col-span-2 bg-[#EF769D] h-[52.63px] rounded-[10px] flex items-center justify-center font-semibold text-lg text-white shadow-lg">
						<div className="absolute">ล้างข้อมูล</div>
					</div>
...
const Section2 = () => (
	<section className="mb-5">
		<div className="text-base font-semibold mb-4">เงื่อนไขการแทง</div>

		<div className="flex flex-col gap-3">
			<Card>
				<div className="grid grid-cols-2">
					<div className="text-sm font-semibold px-4 py-3 border-[#F2F2F2] border-b border-r">สามตัวบน</div>
					<div className="text-sm font-semibold px-4 py-3 border-[#F2F2F2] border-b">สามตัวโต๊ด</div>
					<div className="px-4 py-3 border-[#F2F2F2] border-r">
						<div className="flex flex-col gap-2">
							<div className="flex justify-between">
								<div className="text-xs font-medium text-[#888888]">ราคาจ่าย</div>
								<div className="text-xs font-medium text-[#D11500]">800</div>
							</div>
							<div className="flex justify-between">
								<div className="text-xs font-medium text-[#888888]">แทงขั้นต่ำต่อครั้ง</div>
								<div className="text-xs font-medium text-[#D11500]">1</div>
							</div>
							<div className="flex justify-between">
								<div className="text-xs font-medium text-[#888888]">แทงสูงสุดต่อครั้ง</div>
								<div className="text-xs font-medium text-[#D11500]">500</div>
							</div>
							<div className="flex justify-between">
								<div className="text-xs font-medium text-[#888888]">แทงสูงสุดต่อเลข</div>
								<div className="text-xs font-medium text-[#D11500]">500</div>
							</div>
						</div>
					</div>
			...
			<Card>
				<div className="grid grid-cols-2">
					<div className="text-sm font-semibold px-4 py-3 border-[#F2F2F2] border-b border-r">สองตัวบน</div>
					<div className="text-sm font-semibold px-4 py-3 border-[#F2F2F2] border-b">สองตัวล่าง</div>
					<div className="px-4 py-3 border-[#F2F2F2] border-r">
						<div className="flex flex-col gap-2">
							<div className="flex justify-between">
								<div className="text-xs font-medium text-[#888888]">ราคาจ่าย</div>
			...
			<Card>
				<div className="grid grid-cols-2">
					<div className="text-sm font-semibold px-4 py-3 border-[#F2F2F2] border-b border-r">วิ่งบน</div>
					<div className="text-sm font-semibold px-4 py-3 border-[#F2F2F2] border-b">วิ่งล่าง</div>
					<div className="px-4 py-3 border-[#F2F2F2] border-r">
						<div className="flex flex-col gap-2">
							<div className="flex justify-between">
								<div className="text-xs font-medium text-[#888888]">ราคาจ่าย</div>
			...
			<Card className="pt-3.5 pb-[18px]">
				<div className="px-5 flex flex-col items-center">
					<div className="py-1 px-3 bg-[#EF769D] rounded max-w-fit mb-2.5">
						<div className="text-xs font-medium text-black">สามตัวบน</div>
					</div>
...
const Section5 = () => (
	<section className="mb-5">
		<div className="flex flex-col justify-center items-center bg-white rounded-md py-4 mb-4">
			<div className="text-[#1E1E1E] font-semibold">ผลรวม</div>
			<div className="text-[#F8AA02] text-[32px] font-semibold">0</div>
		</div>

		<label className="flex text-base font-medium text-[#1E1E1E] mb-3">กรอกตัวเลข 5 หลัก</label>
		<input
		...
		<div className="flex gap-2">
			...
			<button className="button_1 w-full rounded font-semibold">เพิ่มเลข</button>
		</div>
	</section>
);
...
const Section6 = () => (
	<section>
		<div className="flex justify-between mb-4">
			<div className="text-[#1E1E1E] text-base font-semibold">จำนวนยิงเลขทั้งหมด</div>
		...
		<section className="mb-5">
			<Card className="pt-3.5 pb-[18px]">
				<div className="px-5 flex flex-col items-center">
					...
					<div className="text-black text-sm font-semibold mb-3">19 ประตู</div>
					...
					<div className="text-black text-sm font-semibold mb-3">รูดหน้า</div>
					...
					<div className="text-black text-sm font-semibold mb-3">รูดหลัง</div>
				...
				<div className="px-5">
					<div className="grid grid-cols-6 gap-2 mb-4">
						<Card className="border border-[#E2E2E2] rounded-md py-3 text-center col-span-3">
							<div className="text-[#FE1A01] text-sm font-medium">เลขเบิ้ล</div>
						</Card>
						<Card className="border border-[#E2E2E2] rounded-md py-3 text-center col-span-3">
							<div className="text-[#FE1A01] text-sm font-medium">สองตัวต่ำ</div>
						</Card>
						<Card className="border border-[#E2E2E2] rounded-md py-3 text-center col-span-2">
							<div className="text-[#FE1A01] text-sm font-medium">สองตัวสูง</div>
						</Card>
						<Card className="border border-[#E2E2E2] rounded-md py-3 text-center col-span-2">
							<div className="text-[#FE1A01] text-sm font-medium">สองตัวคี่</div>
						</Card>
						<Card className="border border-[#E2E2E2] rounded-md py-3 text-center col-span-2">
							<div className="text-[#FE1A01] text-sm font-medium">สองตัวคู่</div>
						</Card>
					</div>
	...
	return (
		<main role="main" className="home_container">
			<section className="mb-5">
				...
				<div className="text-sm font-medium text-[#888888] text-center mt-2">ปิดรับ 19/01/2566 12:30</div>
			</section>
